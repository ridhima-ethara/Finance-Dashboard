...
export const MODEL_KEYS = [
  ...
  { id: "k3", project: "talos", projectName: "Talos", provider: "Google", model: "Gemini 2.5 Pro", type: "Production", env: "production", fullKey: "AIza-live-C13H82Ye7dc5oghi3", tags: ["prod", "classify"], lastUsed: "2026-06-24T11:44:00Z", usage: 2984, createdBy: "Maria Lopez", createdAt: "2026-05-28T09:00:00Z", status: "active" },
  ...
  { id: "k6", project: "atlas", projectName: "Atlas Ingest", provider: "OpenAI", model: "GPT-4o", type: "Production", env: "production", fullKey: "sk-oai-live-F31L45Bp9hd3rpqr8", tags: ["prod", "ingest"], lastUsed: "2026-06-24T05:33:00Z", usage: 8102, createdBy: "Arjun Mehta", createdAt: "2026-06-01T08:00:00Z", status: "active" },
  { id: "k7", project: "atlas", projectName: "Atlas Ingest", provider: "OpenAI", model: "GPT-4o", type: "Production", env: "testing", fullKey: "sk-oai-test-G62M56Cq0je4stuv9", tags: ["test"], lastUsed: "2026-06-19T10:00:00Z", usage: 240, createdBy: "Arjun Mehta", createdAt: "2026-06-01T08:15:00Z", status: "active" },
  { id: "k8", project: "vesper", projectName: "Vesper Docker", provider: "Anthropic", model: "Opus 4.8", type: "Production", env: "production", fullKey: "sk-ant-live-H73N67Dr1kf5tuwx0", tags: ["prod"], lastUsed: "2026-06-15T09:00:00Z", usage: 3812, createdBy: "Aanya Sharma", createdAt: "2026-05-20T14:00:00Z", status: "revoked" },
  { id: "k9", project: "nimbus", projectName: "Nimbus QC", provider: "xAI", model: "Grok-2", type: "Production", env: "production", fullKey: "xai-live-I84O78Es2lg6uvxy1", tags: ["prod", "qc"], lastUsed: "2026-06-23T22:14:00Z", usage: 942, createdBy: "Maria Lopez", createdAt: "2026-06-12T12:00:00Z", status: "active" },
];
